...
export default function AudioPlayer({ 
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-lg p-3 flex items-center gap-4 shadow-sm">
      ...
      <button
        onClick={togglePlay}
        className="w-10 h-10 flex items-center justify-center rounded-full bg-orange-500 text-white hover:bg-orange-600 transition-colors shadow-sm flex-shrink-0"
      >
