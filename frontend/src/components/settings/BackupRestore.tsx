        ...
        <div className="pb-6 border-b border-surface-border">
          ...
          {exportTaskId ? (
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-foreground bg-action hover:bg-action focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-action disabled:opacity-50 transition-colors"
            >
