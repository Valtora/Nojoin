                        ...
                        <Panel defaultSize={75} minSize={30}>
                            <div className="flex-1 flex flex-col min-h-0 h-full">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-900 border-b-2 border-gray-200 dark:border-gray-700 flex-shrink-0">
                                    <div className="flex">
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-6 py-3 text-sm font-medium transition-colors border-b-2 -mb-0.5 ${activePanel === 'transcript'
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-6 py-3 text-sm font-medium transition-colors border-b-2 -mb-0.5 ${activePanel === 'notes'
                                                ? 'border-orange-500 text-orange-600 dark:text-orange-400 bg-white dark:bg-gray-800'
                                                : 'border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-6 py-3 text-sm font-medium transition-colors border-b-2 -mb-0.5 ${activePanel === 'documents'
                                                ? 'border-orange-500 text-orange-600 dark:text-orange-400 bg-white dark:bg-gray-800'
                                                : 'border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800'
                                                }`}
                                        >
                                ...
                                <div className="flex-1 flex flex-col bg-white dark:bg-gray-800 overflow-hidden min-h-0 h-full relative">
                                    ...
                                    <div className={`absolute inset-0 flex flex-col ${activePanel === 'documents' ? 'z-10 visible' : 'z-0 invisible'}`}>
