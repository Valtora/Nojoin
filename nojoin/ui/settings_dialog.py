...
class SettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.gemini_api_key_reveal = QPushButton("👁")
        ...
        self.openai_api_key_reveal = QPushButton("👁")
        ...
        self.anthropic_api_key_reveal = QPushButton("👁")
    ...
    def _load_config(self):
        ...
        self.model_size_combo.setCurrentText(cfg.get("whisper_model_size", "base"))
