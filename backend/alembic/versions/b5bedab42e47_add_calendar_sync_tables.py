...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_calendar_provider_configs_provider"),
        "calendar_provider_configs",
        ["provider"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_calendar_connections_email"),
        "calendar_connections",
        ["email"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_calendar_connections_provider_account_id"),
        "calendar_connections",
        ["provider_account_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calendar_connections_sync_status"),
        "calendar_connections",
        ["sync_status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_calendar_sources_connection_id"),
        "calendar_sources",
        ["connection_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calendar_sources_is_selected"),
        "calendar_sources",
        ["is_selected"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calendar_sources_provider_calendar_id"),
        "calendar_sources",
        ["provider_calendar_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "calendar_id", "provider_event_id", name="uq_calendar_event_calendar_remote"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_calendar_events_end_date"),
        "calendar_events",
        ["end_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_calendar_events_is_all_day"),
        "calendar_events",
        ["is_all_day"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_calendar_events_start_date"),
        "calendar_events",
        ["start_date"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_calendar_events_provider_event_id"), table_name="calendar_events"
    )
    ...
    op.drop_index(
        op.f("ix_calendar_sources_provider_calendar_id"), table_name="calendar_sources"
    )
    op.drop_index(
        op.f("ix_calendar_sources_is_selected"), table_name="calendar_sources"
    )
    op.drop_index(
        op.f("ix_calendar_sources_connection_id"), table_name="calendar_sources"
    )
    op.drop_table("calendar_sources")
    op.drop_index(
        op.f("ix_calendar_connections_user_id"), table_name="calendar_connections"
    )
    op.drop_index(
        op.f("ix_calendar_connections_sync_status"), table_name="calendar_connections"
    )
    op.drop_index(
        op.f("ix_calendar_connections_provider_account_id"),
    ...
    op.drop_index(
        op.f("ix_calendar_connections_provider"), table_name="calendar_connections"
    )
    op.drop_index(
        op.f("ix_calendar_connections_email"), table_name="calendar_connections"
    )
    op.drop_table("calendar_connections")
    op.drop_index(
        op.f("ix_calendar_provider_configs_provider"),
        table_name="calendar_provider_configs",
    )
