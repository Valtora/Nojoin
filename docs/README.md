...
- [pipeline-refactor.md](pipeline-refactor.md): Waterfall implementation plan for the unified live transcription, diarization, speaker identity, and final processing refactor.
- [pipeline-baseline-2026-05-19.md](pipeline-baseline-2026-05-19.md): Initial Phase 0 baseline harness and current pipeline behavior report.
