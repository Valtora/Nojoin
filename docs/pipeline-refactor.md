...
- [x] Keep Companion upload cadence flexible.
  ...
  - [x] Treat user cancellation as a terminal upload-session closure so the Companion stops retrying stale uploads or finalize calls and returns to ready-state immediately.
